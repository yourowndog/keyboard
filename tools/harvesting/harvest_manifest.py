...
DEFAULT_OUTPUT_DIR = REPO / "data/harvest/reports"
...
def run_diagnostics(filepath, output_dir=DEFAULT_OUTPUT_DIR):
    ...
    json_path = output_dir / "harvest_manifest.json"
    output_data = {
        "file_metrics": {
...
if __name__ == "__main__":
    ...
    run_diagnostics(input_path, output_path)
