...
HARVEST_FILE = REPO / "data/harvest/raw/usage_harvest.md"
REPORT_DIR = REPO / "data/harvest/reports"
DERIVED_DIR = REPO / "data/harvest/derived"
...
"""
    ...
    def write_outputs(self, report, typing_bigrams, voice_bigrams, combined_bigrams, rejections, dictionary_gaps, personal_phrases=None):
        ...
        # Summary report
        with open(REPORT_DIR / "harvest_summary.md", 'w', encoding='utf-8') as f:
            f.write(report)
        print("   ✅ harvest_summary.md")

        # Anti-corrections
        with open(DERIVED_DIR / "anti_corrections.txt", 'w', encoding='utf-8') as f:
        ...
        # Dictionary additions
        with open(DERIVED_DIR / "dictionary_additions.txt", 'w', encoding='utf-8') as f:
        ...
        # Bigrams - Typing
        with open(DERIVED_DIR / "bigrams_typing.tsv", 'w', encoding='utf-8') as f:
        ...
        # Bigrams - Voice
        with open(DERIVED_DIR / "bigrams_voice.tsv", 'w', encoding='utf-8') as f:
            for bg, freq in sorted(voice_bigrams.items(), key=lambda x: x[1], reverse=True):
                f.write(f"{bg}\t{freq * 10}\n")
        print("   ✅ bigrams_voice.tsv")

        # Bigrams - Combined
        with open(DERIVED_DIR / "bigrams_combined.tsv", 'w', encoding='utf-8') as f:
        ...
        if personal_phrases:
            with open(DERIVED_DIR / "personal_phrases.tsv", 'w', encoding='utf-8') as f:
        ...
        # Problem patterns
        with open(DERIVED_DIR / "problem_patterns.txt", 'w', encoding='utf-8') as f:
